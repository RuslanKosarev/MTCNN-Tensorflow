...
def read_single_tfrecord(config, tfrecord_file, batch_size):
    ...
    image, label, roi, landmark = tf.train.batch([image, label, roi, landmark],
                                                 batch_size=batch_size, num_threads=2, capacity=1 * batch_size)
...
def read_multi_tfrecords(config, tfrecord_files, batch_sizes):
    """
    ...
    landmark_image,landmark_label,landmark_roi,landmark_landmark = read_single_tfrecord(config, landmark_dir, landmark_batch_size)
